...
extends j {
    ...
    public Typeface b(Context var1, CancellationSignal var2, b.f[] var3, int var4) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
        // org.benf.cfr.reader.util.ConfusedCFRException: Invalid stack depths @ lbl77.1 : IINC : trying to set 1 previously set to 0
    ...
    public Typeface d(Context context, Resources resources, int n2, String string, int n3) {
        ...
        try {
            font = new Font.Builder(resources, n2).build();
            fontFamily = new FontFamily.Builder(font).build();
        }
