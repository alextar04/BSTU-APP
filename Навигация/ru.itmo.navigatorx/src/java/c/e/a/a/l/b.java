...
implements TypeEvaluator<Integer> {
    ...
    public Object evaluate(float f2, Object object, Object object2) {
        ...
        int n4 = n2;
        float f3 = (float)(255 & n4 >> 24) / 255.0f;
        float f4 = (float)(255 & n4 >> 16) / 255.0f;
        float f5 = (float)(255 & n4 >> 8) / 255.0f;
        float f6 = (float)(n4 & 255) / 255.0f;
        int n5 = n3;
        float f7 = (float)(255 & n5 >> 24) / 255.0f;
        float f8 = (float)(255 & n5 >> 16) / 255.0f;
        float f9 = (float)(255 & n5 >> 8) / 255.0f;
        float f10 = (float)(n5 & 255) / 255.0f;
