...
class GroupsViewModel{
    ...
    func getGroupsList(link: URL, completion: @escaping (([CourseGroups])->Void)){
                ...
                for course in listCourses{
                    ...
                    AF.request(courseGroupslink).responseString{ htmlGroupsCourse in
                        do {
                            ...
                            fatalError("Ошибка при парсинге страницы списка групп!")
                        }
                    }
                }
            } catch{
            fatalError("Ошибка при парсинге страницы списка курсов институтов!")
        }}
    }
