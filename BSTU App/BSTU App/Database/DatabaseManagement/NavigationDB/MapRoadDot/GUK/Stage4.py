...
roadDotsArray = [
    ...
    MapRoadDot(id=140, idMap=4, idOnMap=20, idPremise=115, x=1237, y=1268, audienceX=1237, audienceY=1313),
    MapRoadDot(id=141, idMap=4, idOnMap=21, idPremise=122, x=1294, y=1268, audienceX=1294, audienceY=1225),
    MapRoadDot(id=142, idMap=4, idOnMap=22, idPremise=116, x=1301, y=1268, audienceX=1301, audienceY=1313),
    MapRoadDot(id=143, idMap=4, idOnMap=23, idPremise=123, x=1529, y=1268, audienceX=1529, audienceY=1225),
    MapRoadDot(id=144, idMap=4, idOnMap=24, idPremise=117, x=1555, y=1268, audienceX=1555, audienceY=1313),
    MapRoadDot(id=145, idMap=4, idOnMap=25, idPremise=118, x=1619, y=1268, audienceX=1619, audienceY=1313),
    MapRoadDot(id=146, idMap=4, idOnMap=26, idPremise=119, x=1620, y=1268, audienceX=1620, audienceY=1313),
    MapRoadDot(id=147, idMap=4, idOnMap=27, x=1700, y=1268),
    MapRoadDot(id=148, idMap=4, idOnMap=28, idPremise=120, x=1782, y=1268, audienceX=1782, audienceY=1313),
    MapRoadDot(id=149, idMap=4, idOnMap=29, x=1870, y=1268),
    MapRoadDot(id=150, idMap=4, idOnMap=30, idPremise=121, x=1944, y=1268, audienceX=1944, audienceY=1313),
    # Доп. точки (31 индекс)
    MapRoadDot(id=151, idMap=4, idOnMap=31, idPremise=134, x=1700, y=1162, audienceX=1700, audienceY=1162),
    MapRoadDot(id=152, idMap=4, idOnMap=32, x=1870, y=1162),
    # Точки прямо от входа. (33 индекс)
    MapRoadDot(id=153, idMap=4, idOnMap=33, idPremise=135, x=1969, y=1090, audienceX=1969, audienceY=1090),
    MapRoadDot(id=154, idMap=4, idOnMap=34, x=1969, y=1162),
    MapRoadDot(id=155, idMap=4, idOnMap=35, x=1969, y=1268),
    # Верхний коридор прав. (36 индекс)
    MapRoadDot(id=156, idMap=4, idOnMap=36, idPremise=124, x=1870, y=966, audienceX=1835, audienceY=966),
    MapRoadDot(id=157, idMap=4, idOnMap=37, idPremise=131, x=1870, y=883, audienceX=1913, audienceY=883),
    MapRoadDot(id=158, idMap=4, idOnMap=38, idPremise=125, x=1870, y=808, audienceX=1835, audienceY=808),
    MapRoadDot(id=159, idMap=4, idOnMap=39, idPremise=126, x=1870, y=626, audienceX=1835, audienceY=626),
    MapRoadDot(id=160, idMap=4, idOnMap=40, idPremise=130, x=1870, y=580, audienceX=1913, audienceY=580),
    MapRoadDot(id=161, idMap=4, idOnMap=41, idPremise=127, x=1870, y=452, audienceX=1835, audienceY=452),
    MapRoadDot(id=162, idMap=4, idOnMap=42, idPremise=129, x=1870, y=417, audienceX=1913, audienceY=417),
    MapRoadDot(id=163, idMap=4, idOnMap=43, idPremise=128, x=1870, y=319, audienceX=1870, audienceY=319),
    ]
